import { RECORD_LIST_REQUEST, RECORD_LIST_FAIL, RECORD_LIST_SUCCESS, 
  RECORD_CREATE_REQUEST, RECORD_CREATE_SUCCESS, RECORD_CREATE_FAIL, RECORD_CREATE_RESET,
  RECORD_DETAILS_REQUEST, RECORD_DETAILS_SUCCESS, RECORD_DETAILS_FAIL,
  RECORD_UPDATE_REQUEST, RECORD_UPDATE_SUCCESS, RECORD_UPDATE_FAIL, RECORD_UPDATE_RESET, 
  RECORD_DELETE_REQUEST, RECORD_DELETE_SUCCESS, RECORD_DELETE_FAIL,} from '../constants/recordConstants'
  ...
  export const recordCreateReducer = (state = {}, action) => {
    switch (action.type) {
      ...
      case RECORD_CREATE_RESET:
        return {loading: false, success: false, record: action.payload}  
